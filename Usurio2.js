...
export class Usuario2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  fetchVideos = async () => {
    try {
      const response = await axios.get('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q=Rockmusicradio&type=video&key=AIzaSyAbMNCSf8YKUeQ0HS46azwhXpklqcPW_Ks');
